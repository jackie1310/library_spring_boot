...
import com.jackie.library.services.AuthorService;
...
public class AuthorControllerIntegrationTests {
    ...
    public void testThatCreateAuthorSuccessfullyReturnsSavedAuthor() throws Exception {
        ...
        mockMvc.perform(
                ...
                MockMvcResultMatchers.jsonPath("$.name").value("Jackie Nguyen")
        ).andExpect(
    ...
    public void testThatListAuthorsReturnsListOfAuthors() throws Exception {
        ...
        mockMvc.perform(
                ...
                MockMvcResultMatchers.jsonPath("$[0].name").value("Jackie Nguyen")
        ).andExpect(
